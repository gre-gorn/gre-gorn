...
cross-platform software development. Strong background in **C/C++**, distributed and
real-time systems, network programming, operating systems, embedded systems and
firmware development.

Career rooted in infrastructure, networking and system administration, evolving
naturally into low-level programming, C/C++ enterprise systems, real-time software
and R&D. Experienced in designing, implementing and maintaining long-living systems
on Unix-like platforms, including multithreaded network services and performance-
critical components.

Hands-on experience includes real-time video streaming, VoIP platforms, IoT systems,
computer vision R&D, emulation, game engines and AR systems. Co-author of granted
patents in IoT and AR-related technologies.
...
Worked on ~40 commercial and R&D projects for startups and companies in Europe and
the USA.

**Responsibilities:**
- Design and implementation of system-level components in C/C++
- Development of networked and distributed systems
- Embedded firmware development and hardware integration
- Real-time and performance-critical application development
- Reverse engineering and extension of existing systems
- Collaboration with hardware, backend, mobile and frontend teams
- Technology selection and architectural decision-making
- Full-cycle product development: concept → implementation → deployment → maintenance
...
Worked on ~40 commercial and R&D projects for startups and companies in Europe and
the USA. Roles included system architect, low-level engineer, backend developer,
embedded developer and real-time application developer.
...
Details:
- Game development in 6502 assembly language
- Implemented a complete Tetris clone in x86 assembly
  (DOS4GW, flat memory model)
- Low-level programming: memory layout, CPU instructions, timing, rendering
- Attempt to publish and distribute a first commercial game title
